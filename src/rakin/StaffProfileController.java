...
public class StaffProfileController implements Initializable {
    ...
    @FXML
    private void updateProfileButtonOnAction(ActionEvent event) {
    }

    @FXML
    private void backBtuuonOnAction(ActionEvent event) throws IOException {
